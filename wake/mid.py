"""Offline MMSI -> flag/country lookup.

The first three digits of an MMSI are the ITU Maritime Identification Digits
(MID), which identify the vessel's flag state. No network call needed.
"""
...
MID = {
    ...
    "269": "Switzerland", "270": "Czech Republic", "271": "Türkiye", "272": "Ukraine",
    ...
    "305": "Antigua & Barbuda", "306": "Curaçao", "307": "Aruba", "308": "Bahamas",
    "309": "Bahamas", "310": "Bermuda", "311": "Bahamas", "312": "Belize",
    "314": "Barbados", "316": "Canada", "319": "Cayman Islands", "321": "Costa Rica",
    "323": "Cuba", "325": "Dominica", "327": "Dominican Republic", "329": "Guadeloupe",
    ...
    "555": "Pitcairn", "557": "Solomon Islands", "559": "American Samoa",
    ...
    "607": "St Paul & Amsterdam Is", "608": "Ascension", "609": "Burundi",
    "610": "Benin", "611": "Botswana", "612": "Central African Republic",
    "613": "Cameroon", "615": "Congo", "616": "Comoros", "617": "Cape Verde",
    "618": "Crozet Archipelago", "619": "Côte d'Ivoire", "620": "Comoros",
    ...
    "668": "São Tomé & Príncipe", "669": "Eswatini", "670": "Chad", "671": "Togo",
...
def country_for_mmsi(mmsi):
    """Return the flag state for an MMSI, or None if unknown.

    Normal ship MMSIs are 9 digits with the MID as the first three. Some formats
    carry the MID after a prefix (00.. coast stations, 111.. SAR aircraft,
    98../99.. auxiliary craft and aids to navigation); pure-device MMSIs
    (970/972/974) have no flag.
    """
    try:
        s = str(int(mmsi))
    ...
    if len(s) < 3:
        return None
    if s[:3] in ("970", "972", "974"):
        return None  # SART / MOB / EPIRB devices
    if s.startswith("111"):
        mid = s[3:6]
    elif s.startswith(("00", "98", "99")):
        mid = s[2:5]
    else:
        mid = s[:3]
    return MID.get(mid)
